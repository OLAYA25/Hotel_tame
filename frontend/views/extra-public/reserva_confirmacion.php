...
// Simular datos de reserva (en producción esto se obtendría de la BD)
$reservation = [
    'id' => $reservationId,
    'habitacion_numero' => '101',
    'habitacion_tipo' => 'estandar',
    'nombre' => 'Juan',
    'apellido' => 'Pérez',
        ...
        <div class="confirmation-card">
            ...
            <div class="card-body-custom">
                ...
                <div class="action-buttons mt-4">
                    ...
                    <a href="mailto:?subject=Confirmación de Reserva Hotel Tame&body=Mi reserva #%<?= $reservationId ?> ha sido confirmada. Ver detalles en: <?= $_SERVER['HTTP_HOST'] ?>/Hotel_tame/reserva-confirmacion?reservation_id=<?= $reservationId ?>" class="btn btn-primary-custom">
                        <i class="fas fa-envelope me-2"></i>Enviar por Email
                    </a>
                    <a href="/Hotel_tame/reservas-online" class="btn btn-outline-custom">
                        <i class="fas fa-calendar me-2"></i>Hacer Otra Reserva
                    </a>
                    <a href="/Hotel_tame/" class="btn btn-outline-custom">
