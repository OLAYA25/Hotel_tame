<?php
// No iniciar sesión aquí, ya está iniciada en el archivo principal
...
let notificationManager = {
    ...
    checkNewNotifications() {
        ...
        .catch(error => console.error('Error verificando nuevas notificaciones:', error));
    },
...
function clearNotifications() {
    if (confirm('¿Estás seguro de limpiar todas las notificaciones?')) {
        ...
        .then(data => {
            if (data.success) {
                notificationManager.refreshNotificationList();
            }
        })
