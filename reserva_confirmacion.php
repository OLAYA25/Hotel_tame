...
try {
    ...
    $reservation = Database::fetch($sql, [':reservation_id' => $reservationId]);
        ...
        <div class="confirmation-card">
            ...
            <div class="card-body-custom">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="reservation-details">
                            ...
                            <div class="detail-row">
                                ...
                                <span class="detail-value"><?= (new DateTime($reservation['fecha_salida']))->diff(new DateTime($reservation['fecha_entrada']))->days ?></span>
                            </div>
                ...
                <div class="action-buttons mt-4">
                    ...
                    <a href="mailto:?subject=Confirmación de Reserva Hotel Tame&body=Mi reserva #%<?= $reservationId ?> ha sido confirmada. Ver detalles en: <?= $_SERVER['HTTP_HOST'] ?>/reserva_confirmacion.php?reservation_id=<?= $reservationId ?>" class="btn btn-primary-custom">
