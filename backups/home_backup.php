...
<head>
    ...
    <meta name="description" content="Hotel Tame ofrece comodidad, lujo y servicio excepcional en el corazón de la ciudad. Reserva tu habitación ideal hoy.">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="portal_cliente.php">Mi Reserva</a>
                    </li>
                </ul>
            </div>
        </div>
